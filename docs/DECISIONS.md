...
3. **Fix:** `max_pipeline: 1`. Transactions work (checked against the test project with 0, 1 and 100), and pipelining stays at most one query deep, which still addresses the pooler hang (DECISIONS, PR #100).
