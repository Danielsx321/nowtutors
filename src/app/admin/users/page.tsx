                ...
                <CardContent className="p-0">
                  ...
                  >
                    <div className="min-w-0">
                      <p className="truncate text-body font-bold text-gray-700">
                        {u.displayName ?? u.fullName ?? "No name"}
                      </p>
                      <p className="truncate text-small text-gray-500">{u.email}</p>
                    </div>
                    <div className="flex flex-wrap items-center gap-2">
                      <Badge variant={u.role === "admin" ? "solid" : u.role ? "purple" : "neutral"}>
                      ...
                      <span className="text-small text-gray-500">{u.balance} credits</span>
                    </div>
                  </Link>
                </CardContent>
              </Card>
        ...
        <nav aria-label="Pages" className="flex items-center justify-between gap-3">
          {result.page > 1 ? (
            <Link
              ...
              className="focus-ring text-body font-medium text-purple-700"
            >
              Newer
            </Link>
          ) : (
